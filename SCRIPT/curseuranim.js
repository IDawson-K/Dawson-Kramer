...
function minimiselanavbar() {
    document.querySelector('#navbar').classList.remove('contourhovernavbar');
    document.querySelector('#contour').classList.remove('contourhover');
}

function hoverlanavbartimed() {
    setTimeout(hoverlanavbar, 1000);
}
